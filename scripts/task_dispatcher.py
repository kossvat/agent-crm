...
DB_PATH = Path.home() / "projects/agent-crm/data/crm.db"
DISPATCH_LOG = Path.home() / "projects/agent-crm/data/dispatched.json"

# Agent ID → session key mapping
AGENT_SESSIONS = {
    1: "agent:career:telegram:direct:1080204489",      # Rex
    2: "agent:main:telegram:direct:1080204489",         # Caramel
    3: "agent:sixteen:telegram:direct:1080204489",      # Sixteen
    4: "agent:social:telegram:direct:1080204489",       # Vibe
}
